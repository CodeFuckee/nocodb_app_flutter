...
abstract class AppLocalizations {
  ...
  /// No description provided for @mistakeBookTableId.
  ///
  /// In en, this message translates to:
  ...
  ///
  /// In en, this message translates to:
  /// **'No more records or empty table.'**
  ...
  /// No description provided for @nocodbUrlHint.
  ///
  /// In en, this message translates to:
  /// **'https://app.nocodb.com'**
  String get nocodbUrlHint;
